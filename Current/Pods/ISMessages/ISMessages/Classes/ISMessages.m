...
static CGFloat const kDefaultCardViewHeight = 31.f;
...
- (instancetype)initCardAlertWithTitle:(NSString*)title
    ...
    if (self) {
        ...
        self.iconImageSize = _iconImage == nil ? CGSizeZero : CGSizeMake(21.f, 21.f);
...
- (void)constructAlertCardView {
    ...
    messageLabel.frame = CGRectMake((kDefaulInset*2.f) + _iconImageSize.width, kDefaulInset + _titleLabelHeight, self.view.frame.size.width - ((kDefaulInset*3.f) + _iconImageSize.width), _messageLabelHeight);
...
- (void)configureViewForAlertType:(ISAlertType)alertType iconImage:(UIImage*)iconImage {
    ...
    self.titleLabelFont = [UIFont fontWithName:@"SourceSansPro-SemiBold" size:18];
    self.messageLabelFont = [UIFont fontWithName:@"SourceSansPro-SemiBold" size:15];
    
    self.iconImage = iconImage;
    
    switch (alertType) {
        case ISAlertTypeSuccess: {
            self.alertViewBackgroundColor = [UIColor colorWithRed:20.0f/255.f green:160.f/255.f blue:20.f/255.f alpha:1.f];
            if (!_iconImage) {
        ...
        case ISAlertTypeWarning: {
            self.alertViewBackgroundColor = [UIColor colorWithRed:240.f/255.f green:10.f/255.f blue:10.f/255.f alpha:1.f];
            if (!_iconImage) {
