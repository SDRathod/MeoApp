...
class PT_MyReviewsVC: STableViewController {
...
extension PT_MyReviewsVC {
    ...
    func getPatientMyReviewListCall() {
        ...
        param.setValue("\(intPageIndex)", forKey: "form[page]")
        ...
        AFAPIMaster.sharedAPIMaster.getPatientMyReviewsListDataCall_Completion(params: param, showLoader: boolLoader, enableInteraction: false, viewObj: self.view, onSuccess: { (returnData: Any) in
                        ...
                        for i in 0 ..< arrResultData.count {
                            if let dictReview: NSDictionary = arrResultData.object(at: i) as? NSDictionary {
                                ...
                                if let dictProvider: NSDictionary = dictReview.object(forKey: "provider") as? NSDictionary {
                                    ...
                                    shareObj.strProfilePic = dictProvider.object(forKey: "profilePictureUrl") as? String ?? ""
                                    shareObj.strSalutation = dictProvider.object(forKey: "salutation") as? String ?? ""
                                    shareObj.strFirstName = dictProvider.object(forKey: "firstName") as? String ?? ""
                                    shareObj.strLastName = dictProvider.object(forKey: "lastName") as? String ?? ""
                                }
