...
class PT_WriteReviewStep2VC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if (shareObjReview.arrReviewGroupList.count > 0) {
            let shareObjGroup = shareObjReview.arrReviewGroupList[0]
...
//MARK: -
extension PT_WriteReviewStep2VC {
    // MARK: -  API Call
    ...
    @IBAction func btnNextClick(_ sender: Any) {
        ...
        if (shareObjReview.arrReviewGroupList.count > 0) {
            ...
            let pt_writeReviewStep3Obj = PT_WriteReviewStep3VC(nibName: "PT_WriteReviewStep3VC", bundle: nil)
            pt_writeReviewStep3Obj.strSelProviderId = self.strSelProviderId
            pt_writeReviewStep3Obj.dictSelProviderData = self.dictSelProviderData
            pt_writeReviewStep3Obj.isNavFavScreen = self.isNavFavScreen
            pt_writeReviewStep3Obj.shareObjReview = self.shareObjReview
            self.navigationController?.pushViewController(pt_writeReviewStep3Obj, animated: true)
        }
    }
}

// MARK: -
extension PT_WriteReviewStep2VC: UITableViewDataSource, UITableViewDelegate {
...
//MARK: -
extension PT_WriteReviewStep2VC : TPFloatRatingViewDelegate {
...
//MARK: -
extension PT_WriteReviewStep2VC : MDHTMLLabelDelegate {
...
//MARK: -
extension PT_WriteReviewStep2VC : UITextViewDelegate {
