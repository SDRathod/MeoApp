...
class ProviderDashboardVC: STableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if (segmentAppoint.selectedSegmentIndex == 0) {
            ...
            self.getProviderTodayAppointmentList()
        }
        else {
            intWaitingCurrentPage = 0
            self.getProviderWaitingAppointmentList()
        }
    }
...
//MARK: -
extension ProviderDashboardVC {
    // MARK: -  API Call Methods
    func getProviderTodayAppointmentList() {
        ...
        AFAPIMaster.sharedAPIMaster.getProviderTodaysAppointmentListDataCall_Completion(params: param, showLoader: boolLoader, enableInteraction: false, viewObj: self.view, onSuccess: { (returnData: Any) in
    ...
    func getProviderWaitingAppointmentList() {
        ...
        AFAPIMaster.sharedAPIMaster.getProviderWaitingAppointmentListDataCall_Completion(params: param, showLoader: boolLoader, enableInteraction: false, viewObj: self.view, onSuccess: { (returnData: Any) in
            let dictResponse: NSDictionary = returnData as! NSDictionary
    ...
    @IBAction func btnMyAppointmentClick(_ sender: Any) {
        let providerSchedulingObj = ProviderSchedulingVC(nibName: "ProviderSchedulingVC", bundle: nil)
        providerSchedulingObj.boolIsFromSlideMenu = false
        providerSchedulingObj.boolIsAppointmentSel = true
        self.navigationController?.pushViewController(providerSchedulingObj, animated: true)
    }
    
    @IBAction func btnMyReviewsClick(_ sender: Any) {
        let pr_myReviewsObj = PR_MyReviewsVC(nibName: "PR_MyReviewsVC", bundle: nil)
        pr_myReviewsObj.boolIsFromSlideMenu = false
        self.navigationController?.pushViewController(pr_myReviewsObj, animated: true)
    }
...
// MARK: -
extension ProviderDashboardVC: UITextViewDelegate {
