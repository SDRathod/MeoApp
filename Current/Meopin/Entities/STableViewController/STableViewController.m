...
#define DEFAULT_HEIGHT_OFFSET 55.0f
...
- (void) setHeaderView:(UIView *)aView
{
    ...
    if (aView) {
        ...
        headerView.frame = CGRectMake(f.origin.x, 0 - f.size.height, f.size.width, 0);
...
- (BOOL) loadMore
{
  ...
  if (self.tableView.contentSize.height < ([UIScreen mainScreen].bounds.size.height - 300))
    return NO;
