...
@class KPDropMenuMultiRepeat;

@protocol KPDropMenuMultiRepeatDelegate <NSObject>

@optional
-(void)didSelectItem : (KPDropMenuMultiRepeat *) dropMenu arrSelectedIndex : (NSMutableArray *) selectedIndex;
- (void)didCancelTapDelegateMethod;
-(void)didShow : (KPDropMenuMultiRepeat *)dropMenu;
-(void)didHide : (KPDropMenuMultiRepeat *)dropMenu;

@end

IB_DESIGNABLE

@interface KPDropMenuMultiRepeat : UIView

@property (nonatomic, assign) int SelectedIndex;
@property (nonatomic, retain) UITableView *tblView;
@property (nonatomic, retain) id <KPDropMenuMultiRepeatDelegate> delegate;
