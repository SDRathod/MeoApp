...
extension UITextField {
    ...
    func paddingRightLeftviewWithCustomValue(_ value:CGFloat,txtfield:UITextField){
        let l3 = UIView(frame: CGRect(x: 0, y: 0,width: value, height: txtfield.frame.height))
        let R3 = UIView(frame: CGRect(x: 0, y: 0,width: 50, height: txtfield.frame.height))
        txtfield.leftView = l3
        txtfield.rightView = R3
        txtfield.leftViewMode = UITextFieldViewMode.always
